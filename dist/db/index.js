...
var Database = /** @class */ (function () {
    function Database() {
        var _this = this;
        this.createLocation = function (location) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var text = 'INSERT INTO geo_location ( name, point )';
                        var point = "(".concat(location.longitude, ",").concat(location.latitude, ")");
                        var values = [location.name, point];
                        _this.pool.connect()
